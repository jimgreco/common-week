...
final class WeekDateTests: XCTestCase {
    ...
    func testGeocodedLocationAssignmentPreservesTheReuseChoice() throws {
        ...
        let request = GeocodedLocationAssignmentRequest(date: "2026-08-14", memberIds: ["member-1"], scope: "day", result: result, saveForReuse: false)
        ...
        XCTAssertEqual(payload["memberIds"] as? [String], ["member-1"])
