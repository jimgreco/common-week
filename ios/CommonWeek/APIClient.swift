...
final class APIClient {
    ...
    func coverage() async throws -> [EventCoverage] { try await send(path: "/api/coverage") }
    func saveCoverage(_ entry: EventCoverage) async throws -> [EventCoverage] { try await send(path: "/api/coverage", method: "POST", body: entry) }
