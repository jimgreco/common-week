    ...
    <LegalPage
      ...
      sections={[
        ...
        },
        {
          ...
          paragraphs: [
            "Calendar names and events are shared with members of your Week of Us household only when you choose Share for that calendar. A household member can add, edit, or delete events only when that person enables Calendar editing and Google grants their own connected account write access to the calendar. Week of Us uses the acting member’s Google connection for every write. Private calendars remain visible only to their owner, hidden calendars do not appear in the app, and viewer household roles cannot edit events. We do not sell personal data. We disclose data only to infrastructure providers acting on our behalf, when you direct us to, to protect the service and its users, or when legally required.",
